Data Analysis: Contains python code for the anakysis methods as well as raw and processed data in CSV format. Also included is Apps Script for Firestore Export
